...
@Component({
  selector: 'app-detail-type-array',
  templateUrl: './detail-type-array.component.html',
  styleUrls: ['./detail-type-array.component.css']
})
export class DetailTypeArrayComponent implements OnInit {
